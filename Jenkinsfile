pipeline {
    ...
    stages {
        ...
        stage('deployjenkins') { 
            steps { 
                sh 'kubectl apply -f https://raw.githubusercontent.com/abrahamlp/ctt-devops-eks/main/jenkins.yaml'
            }
        }
        stage('deploynexus') { 
            steps { 
                sh 'kubectl apply -f https://raw.githubusercontent.com/abrahamlp/ctt-devops-eks/main/nexus-repository.yaml'
            }
        }
        stage('deploygitlab') { 
            steps { 
                sh 'kubectl apply -f https://raw.githubusercontent.com/abrahamlp/ctt-devops-eks/main/gitlab.yaml'
            }
        }
        stage('configureingress') { 
            steps { 
                sh 'kubectl apply -f https://raw.githubusercontent.com/abrahamlp/ctt-devops-eks/main/services-ingress.yaml'
            }
        }
    }
    post {
